class CreateSentSms < ActiveRecord::Migration
  def change
    create_table :sent_sms, :id => false do |t|
    ...
    execute 'ALTER TABLE `sent_sms` ADD PRIMARY KEY (`id`);'
    execute 'ALTER TABLE `sent_sms` CHANGE `id` `id` BIGINT(20) NOT NULL AUTO_INCREMENT;'
  end
end
