...
$(document).ready(function() {
    $('form.new_contact, form.edit_contact').on('submit', function(e) {
        ...
        if(empty(prefix)) {
            errors.push(I18n.t('contact_group_form.prefix_required'));
        } else if(!validMaxLength(prefix, 6)) {
            errors.push(I18n.t('contact_group_form.prefix_max_length'));
        }

        if(!validNumber(prefix)) {
            errors.push(I18n.t('contact_group_form.prefix_numeric'));
        }

        if(empty(mobile)) {
            errors.push(I18n.t('contact_group_form.mobile_required'));
        } else if(!validMinLength(mobile, 2)) {
            errors.push(I18n.t('contact_group_form.mobile_min_length'));
        } else if(!validMaxLength(mobile, 14)) {
            errors.push(I18n.t('contact_group_form.mobile_max_length'));
        }

        if(!validNumber(mobile)) {
            errors.push(I18n.t('contact_group_form.mobile_numeric'));
        }
