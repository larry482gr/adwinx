...
$(document).ready(function() {
    ...
    $('#contacts-table').on('change', '.contact-check', function() {
        ...
        if(checked > 0) {
            ...
            if(checked == all) {
                $('#select-page-contacts').removeClass('btn-primary').addClass('btn-default');
            } else {
                $('#select-page-contacts').removeClass('btn-default').addClass('btn-primary');
            }
        } else {
